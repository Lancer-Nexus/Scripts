...
| Agent | `agent.env.example` | None; outbound QUIC UDP 7443 to Coordinator | .NET worker sends mTLS Hello and sequenced Agent heartbeats; optional instance heartbeat reads the matching LLServer runtime-status file; host lifecycle remains unimplemented |
